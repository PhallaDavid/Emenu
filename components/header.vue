<template>
  ...
  >
              ...
              >
                <div class="p-2">
                  ...
                  <div
                    ...
                    class="text-gray-500 text-center p-2 text-sm"
                  >
                    No notifications
                  </div>
                </div>
    ...
    <transition name="slide">
      <div
        v-if="sidebarOpen"
        class="fixed inset-0 backdrop-blur-sm z-50 flex justify-end"
        @click.self="sidebarOpen = false"
      >
        <div class="w-72 h-full p-6 flex flex-col animate-slide-in">
          <button
            @click="sidebarOpen = false"
            class="self-end px-2 py-2 text-gray-800 hover:text-gray-800 mb-6"
          >
