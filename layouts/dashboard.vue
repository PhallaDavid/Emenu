<template>
  <div class="flex">
    ...
    <div class="flex-1 flex flex-col min-h-screen sm:ml-64">
      <!-- Top bar (mobile only) -->
      <header class="flex items-center justify-between p-4 bg-gray-50 shadow-md sm:hidden">
      ...
      <header class="hidden sm:flex items-center justify-end p-4 bg-white shadow-md border-b">
        ...
        <div class="flex items-center space-x-4">
          ...
          <div class="flex items-center space-x-2">
            <img src="/images/kh1.PNG" alt="Profile" class="w-8 h-8 rounded-full" />
